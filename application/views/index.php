...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="css/plugins/flat/blue.css">
    <!-- Morris chart -->
    <link rel="stylesheet" href="css/plugins/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="css/plugins/jquery-jvectormap-1.2.2.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="css/plugins/datepicker3.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="css/plugins/daterangepicker-bs3.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <script src="js/plugins/jquery-jvectormap-world-mill-en.js"></script>
    <!-- jQuery Knob Chart -->
